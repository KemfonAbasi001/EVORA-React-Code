...
//         />
//         <p className="bg-[#10b981] text-[#f9fafb] absolute top-3 text-[10px] py-1.25 rounded-xl px-2.5 left-4 uppercase">
//           {tag}
//         </p>
//       </div>
//       <div className="py-4 px-4 flex gap-2.75 flex-col flex-1">
//         <h1 className="font-medium text-[16px] text-[#111827] line-clamp-2">{title}</h1>
//         <span className="text-[12px] text-normal flex justify-between mt-auto">
...
//             Read More <MoveRight className="w-3 h-4" />
//           </a>
//         </span>
//       </div>
//     </div>
...
//           <div className="flex lg:grid justify-center items-center lg:grid-cols-8 gap-3 w-full lg:w-fit overflow-x-auto pb-2 lg:pb-0 -mx-1 px-1 lg:mx-0 lg:px-0 scrollbar-hide">
//             {categories.map((category) => (
//               <button
//                 key={category}
//                 onClick={() => setActiveCategory(category)}
//                 className={`lg:text-[13px] text-[15px] py-1 px-2 rounded-lg border whitespace-nowrap shrink-0 transition-colors ${
...
//               <h1 className="font-semibold text-[22px]">Latest Articles</h1>
//               <a href="" className="text-[#10b981] text-[13px] flex gap-1 justify-center items-center font-medium">View All Posts <MoveRight className="w-3 h-4" /></a>
//             </span>

//             <div className="w-full grid grid-cols-3 gap-10 items-stretch">
...
//           className="object-cover transition-transform duration-300 group-hover:scale-105"
//         />
//         <p className="text-[#10b981] bg-[#f9fafb] absolute top-4 text-[14px] py-1.25 rounded-[5px] font-semibold px-3 left-4">
//           {rank}
//         </p>
//       </div>
//       <div className="py-4 px-4 flex gap-2.75 flex-col flex-1">
...
//           <div className="flex flex-col gap-6 w-full">
//             <span className="w-full flex justify-between ">
//               <h1 className="font-semibold text-[22px]">Trending Now</h1>
//               <a href="" className="text-[#10b981] text-[13px] flex gap-1 justify-center items-center font-medium">View All Posts <MoveRight className="w-3 h-4" /></a>
//             </span>
...
//             <h1 className="font-medium text-[27px] lg:text-[45px] text-[#111827]">Latest Insights</h1>
//             <p className="lg:text-[17px] text-[15px] text-[#374151] w-[40%]">News, innovation and stories shaping the future of electric mobility.</p>
...
//         <div className="flex gap-3 w-[400px] flex-col ">
//           <h1 className="text-[32px] leading-[45px] font-semibold text-[#f9fafb]">Ready to Experience Sustainable Mobility?</h1>
//           <p className="text-[15px] text-[#f3f4f6]">Book a test ride and discover the future of driving with EVORA.</p>
        ...
        <div className="flex flex-col gap-8 lg:gap-15 w-full justify-center items-center">
          ...
          <div className="flex flex-col gap-6 w-full">
            <span className="w-full flex justify-between items-center">
              <h1 className="font-semibold text-[18px] lg:text-[22px]">Latest Articles</h1>
              <a href="" className="text-[#10b981] text-[12px] lg:text-[13px] flex gap-1 justify-center items-center font-medium">View All Posts <MoveRight className="w-3 h-4" /></a>
            </span>
    ...
    <section className="w-full flex justify-center items-center py-8 lg:py-0 bg-[#f9fafb]">
      <div className="w-[95%] flex flex-col gap-9">
        <div className="flex flex-col gap-6 lg:gap-10 w-full justify-center items-center">
          ...
          <div className="flex flex-col gap-6 w-full">
            <span className="w-full flex justify-between items-center">
              <h1 className="font-semibold text-[18px] lg:text-[22px]">Trending Now</h1>
              <a href="" className="text-[#10b981] text-[12px] lg:text-[13px] flex gap-1 justify-center items-center font-medium">View All Posts <MoveRight className="w-3 h-4" /></a>
            </span>
    ...
    <section className="w-full flex justify-center items-center py-14 lg:py-30 bg-[#f9fafb]" id="two">
      <div className="w-[95%]">
         <span className="w-full flex flex-col">
            <h1 className="font-medium text-[26px] lg:text-[45px] text-[#111827]">Latest Insights</h1>
            <p className="text-[14px] lg:text-[17px] text-[#374151] w-full lg:w-[40%]">News, innovation and stories shaping the future of electric mobility.</p>
