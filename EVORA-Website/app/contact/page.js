...
function OurVehicles() {
  return(
    ...
    <div className="w-[95%] flex flex-col gap-9 py-8 px-2 rounded-xl bg-[white] shadow">
        <div className="w-full grid grid-cols-1 lg:grid-cols-3 lg:gap-3 gap-8">
            <div className="flex flex-col gap-6 py-4 px-7">
                <h1 className="lg:text-[19px] text-[22px] font-medium">Contact Information</h1>
                <div className="flex gap-3 items-start">
                    <div className="px-3 py-3 bg-[rgba(16,185,129,0.1)] rounded-full">
                        <Mail className="lg:w-4 w-6 h-6 lg:h-4" />
                    </div>
                    <span className="flex flex-col">
                        <h2 className="text-[18px] lg:text-[14px] font-medium">Email</h2>
                        <p className="text-[17px] font-normal">hello@evora.com</p>
                    </span>
                </div>
                <div className="flex gap-3 items-start">
                    <div className="px-3 py-3 bg-[rgba(16,185,129,0.1)] rounded-full">
                        <Phone className="lg:w-4 w-6 h-6 lg:h-4" />
                    </div>
                    <span className="flex flex-col">
                        <h2 className="text-[18px] lg:text-[14px] font-medium">Phone</h2>
                        <p className="text-[17px] font-normal">+1 (650) 123-4557</p>
                    </span>
                </div>
                <div className="flex gap-3 items-start">
                    <div className="px-3 py-3 bg-[rgba(16,185,129,0.1)] rounded-full">
                        <MapPin className="lg:w-4 w-6 h-6 lg:h-4" />
                    </div>
                    <span className="flex flex-col">
                        <h2 className="text-[18px] lg:text-[14px] font-medium">Address</h2>
                        <p className="text-[17px] font-normal">123 Greenway Blvd,</p>
                        <p className="text-[17px] font-normal">San Francisco, CA 94107</p>
                        <p className="text-[17px] font-normal">United States</p>
                    </span>
                </div>
                <div className="flex gap-3 items-start flex-col">
                    <h2 className="lg:text-[16px] text-[19px] font-medium">Follow Us</h2>
                    <div className="flex gap-3">
                        <div className="px-3 py-3.5 bg-[rgba(229,231,235,0.6)] flex justify-center items-center rounded-full">
                            <FontAwesomeIcon icon={faFacebookF} className="text-[25px] lg:text-[20px] text-[#111827]" />
                        </div>

                        <div className="px-3 py-3.5 bg-[rgba(229,231,235,0.6)] flex justify-center items-center rounded-full">
                            <FontAwesomeIcon icon={faInstagram} className="text-[25px] lg:text-[20px] rounded-full text-[#111827]" />
                        </div>

                        <div className="px-3 py-3.5 bg-[rgba(229,231,235,0.6)] flex justify-center items-center rounded-full">
                            <FontAwesomeIcon icon={faLinkedinIn} className="text-[25px] lg:text-[20px] text-[#111827]" />
                        </div>

                        <div className="px-3 py-3.5 bg-[rgba(229,231,235,0.6)] flex justify-center items-center rounded-full">
                            <FontAwesomeIcon icon={faYoutube} className="text-[25px] lg:text-[20px] text-[#111827]" />
                        </div>
            ...
            <div className="flex flex-col gap-6 py-4 px-7 lg:border-x border-y-0 border-solid border-[#e5e7eb]">
                <h1 className="lg:text-[19px] text-[22px] font-medium">Send Us a Message</h1>
                <input type="name" placeholder="Your Name" className="w-full box-border px-3 py-2.5 border-[#d1d5db] text-[#111827] border rounded-lg text-[16px] lg:text-[13px] outline-[#10b981]"/>
                <input type="email" placeholder="Email Address" className="w-full box-border px-3 py-2.5 border-[#d1d5db] text-[#111827] border rounded-lg text-[16px] lg:text-[13px] outline-[#10b981]"/>
                <textarea typeof="message" placeholder="Message"className="w-full box-border px-3 py-2.5 border-[#d1d5db] text-[#111827] border rounded-lg text-[16px] lg:text-[13px] outline-[#10b981] min-h-[170px]"/>
                <button className="w-full bg-[#10b981] py-2 text-[16px] lg:text-[14px] rounded-lg text-[#f3f4f6]">Send Message</button>
            </div>

            <div className="flex flex-col gap-6 py-4 px-7">
                <h1 className="lg:text-[19px] text-[22px] font-medium">Our Location</h1>
  ...
  return (
    <section className="flex justify-center py-30" id="Contact">
      <div className="w-[93%] flex flex-col lg:flex-row lg:justify-between items-center gap-12 lg:gap-0">
        <div className="gap-3 flex flex-col text-center lg:text-left items-center lg:items-start w-full lg:w-[40%] ">
    ...
    <section className="w-full flex justify-center items-center py-15 bg-[#f3f4f6]">
      <div className="w-[90%] flex flex-col gap-9">
        <span className="flex flex-col gap-2">
          <p className="lg:text-[12px] text-[14px] font-medium text-[#16a34a]">
