  ...
  return (
    <section className="w-full flex justify-center items-center py-20 bg-[#e5e7eb]">
      <div className="w-[95%] flex flex-col gap-9">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-7 items-stretch">
...
//   return(
//     <section className="pt-35.75 pb-10 flex justify-center" id="run">
//       <div className="w-[93%] flex justify-between">
//           <div className="gap-2.5 flex flex-col">
//             <p>
//               100% Electric
//             </p>
//             <h1 className="text-[53px] leading-[60px] font-semibold text-[#111827]">Drive the Future.<br /><span class="text-[#16a34a]">Sustain the World.</span></h1>
//             <p className="text-[19px] text-[#111827]">Smart. Connected. Sustainable.<br/>Electric mobility for a cleaner tomorrow.</p>
//             <div class="flex gap-5 mt-2">
//                 <button class="bg-[#10b981] py-2.75 px-5 rounded-[6px] text-[14px] font-medium">Explore Vehicles</button>
//                 <button class="py-2.75 px-5 border border-solid border-[#374151] text-[14px] font-medium rounded-[6px] text-[#111827]">Find a Dealer</button>
//             </div>
//           </div>
//           <Image src={neww} alt="Electric vehicle" className="w-[48%]" />
//       </div>
//     </section>
//   );
// }
...
function LandingPage() {
  return (
    <section
      className="pt-24 sm:pt-28 lg:pt-35.75 pb-10 flex justify-center"
      id="run"
    >
...
//       <div className="w-[93%] py-4 px-10 rounded-lg grid grid-cols-4 justify-between bg-[#f9fafb] shadow">
//           <div className="flex flex-row gap-4 items-center">
...
function SubLand() {
  return (
    <section className="pt-5 flex justify-center bg-[#f9fafb]">
      <div className="w-[93%] py-4 px-4 sm:px-6 lg:px-10 rounded-lg grid grid-cols-2 lg:grid-cols-4 gap-y-4 gap-x-4 justify-between bg-[#f9fafb] shadow">
        <div className="flex flex-row gap-4 items-center">
          <img className="w-9" src="data:image/png;base64," alt="leaf"></img>
          <span className="flex flex-col">
            <h1 className="text-[13px] font-medium text-[#111827]">Zero Emission</h1>
