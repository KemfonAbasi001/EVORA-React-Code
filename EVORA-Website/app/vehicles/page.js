...
//   { name: "Evora City", type: "Compact EV", image: five, price: "$12,650", fig: "120", amount: "40" },
//   { name: "Evora Keke", type: "Electric Three Wheeler", image: six, price: "$12,650", fig: "80", amount: "50" },
//   { name: "Evora Cab", type: "24/7 EV", image: nine, price: "$12,650", fig: "420", amount: "80" },
//   { name: "Evora Keke", type: "Electric Three Wheeler", image: seven, price: "$12,650", fig: "80", amount: "50" },
//   { name: "Evora Cab", type: "24/7 EV", image: eight, price: "$12,650", fig: "420", amount: "80" },
//   { name: "Evora City", type: "Compact EV", image: thirteen, price: "$12,650", fig: "120", amount: "40" },
//   { name: "Evora Keke", type: "Electric Three Wheeler", image: ten, price: "$12,650", fig: "80", amount: "50" },
//   { name: "Evora Cab", type: "24/7 EV", image: eleven, price: "$12,650", fig: "420", amount: "80" },
//   { name: "Evora Keke", type: "Electric Three Wheeler", image: twelve, price: "$12,650", fig: "80", amount: "50" },
//   { name: "Evora Cab", type: "24/7 EV", image: fourteen, price: "$12,650", fig: "420", amount: "80" },
//   { name: "Evora Cab", type: "24/7 EV", image: fifteen, price: "$12,650", fig: "420", amount: "80" },
// ];
...
function VehicleCard({ name, type, image, price }) {
  return (
    <div className="h-full flex flex-col rounded-lg border border-solid border-[#9ca3af] hover:border-[#16a34a] py-7 px-6">
      ...
      <span className="flex justify-between mt-2">
        <p className="text-[#111827] text-[18.7px] lg:text-[16px] font-medium">
