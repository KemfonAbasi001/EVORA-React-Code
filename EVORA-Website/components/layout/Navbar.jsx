...
//             <Link href="/vehicles" className="flex justify-between items-center" onClick={closeMenu}>
//               Vehicles <ChevronDown size={18} />
//             </Link>

//             <Link href="/about" className="flex justify-between items-center" onClick={closeMenu}>
//               Charging <ChevronDown size={18} />
//             </Link>
...
//             <Link href="/about" onClick={closeMenu}>Blog</Link>
...
export default function Navbar() {
  ...
  const linkClass = (href, base = "") =>
    `${base} ${isActive(href) ? "text-[#16a34a] font-semibold" : "hover:text-green-600"}`;
    ...
    <header className="bg-[#f9fafb] flex justify-center w-full relative">
      <nav className="flex items-center w-[90%] lg:w-[95%] justify-between py-3">
        ...
        <ul className="hidden lg:flex gap-8 text-sm font-medium text-black items-center">
          ...
          {/* <Link href="/blogs" className={linkClass("/blogs")}>Blog</Link> */}
          <Link href="/blog" className={linkClass("/blog")}>Blog</Link>
          <Link href="/contact" className={linkClass("/contact")}>Contact</Link>
          <Link href="/contact" className="bg-[#10b981] flex py-2 px-4 rounded-lg text-[#f9fafb]">Book a Test Ride</Link>
        </ul>
      </nav>
      ...
      >
        <div className="flex flex-col h-full px-6 py-4">
          ...
          <div className="flex flex-col gap-6 mt-8 text-[20px] font-medium text-black">
            ...
            <Link
              href="/vehicles"
              className={linkClass("/vehicles", "flex justify-between items-center")}
              onClick={closeMenu}
            >
              Vehicles <ChevronDown size={18} />
            </Link>
